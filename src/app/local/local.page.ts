...
export class LocalPage {
  ...
  // Add this property to track the currently selected/playing audio
  currentAudio: { assetId: string; name: string; fileName: string } | null = null;
  ...
  async playAudio(assetId: string) {
    await NativeAudio.play({ assetId });
    this.currentAudio = this.loadedAudios.find(audio => audio.assetId === assetId) || null;
  }

  async pauseAudio(assetId: string) {
  ...
  async stopAudio(assetId: string) {
